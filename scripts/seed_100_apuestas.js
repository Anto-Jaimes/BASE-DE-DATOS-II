...
if (partidos.length === 0) {
    ...
    var partidosDemo = [
        { equipo1: "Argentina", equipo2: "Francia", cuotaEquipo1: 2.1, cuotaEquipo2: 2.8, ganador: "", estado: "PENDIENTE", _class: "pe.edu.utp.proyecto.modelo.Partido" },
        { equipo1: "Brasil", equipo2: "Alemania", cuotaEquipo1: 1.8, cuotaEquipo2: 4.0, ganador: "", estado: "PENDIENTE", _class: "pe.edu.utp.proyecto.modelo.Partido" },
        { equipo1: "Inglaterra", equipo2: "España", cuotaEquipo1: 2.5, cuotaEquipo2: 2.5, ganador: "", estado: "PENDIENTE", _class: "pe.edu.utp.proyecto.modelo.Partido" },
        { equipo1: "Perú", equipo2: "Uruguay", cuotaEquipo1: 3.2, cuotaEquipo2: 2.2, ganador: "", estado: "PENDIENTE", _class: "pe.edu.utp.proyecto.modelo.Partido" }
    ];
...
var apuestas = [];
var pronosticos = ["equipo1", "equipo2"]; // SIN EMPATES, SIN LOCALES
...
for (var i = 1; i <= 100; i++) {
    ...
    var cuotaPagada = 1.0;
    if (randomPronostico === "equipo1") cuotaPagada = randomPartido.cuotaEquipo1;
    else if (randomPronostico === "equipo2") cuotaPagada = randomPartido.cuotaEquipo2;
    ...
    apuestas.push({
        ...
        monto: randomMonto,
        pronostico: randomPronostico, // "equipo1" o "equipo2"
